...
<body class="bg-[#F4F7FF] text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between fixed h-screen z-10">
            <div>
                <div class="p-6 flex items-center gap-3 border-b border-gray-50">
                    <div class="w-10 h-10 bg-[#2D3E75] rounded-xl flex items-center justify-center text-white shadow-md">
                ...
                <nav class="p-4 space-y-1.5 mt-4">
                    <a href="#" class="flex items-center gap-3.5 px-4 py-3 text-gray-500 hover:text-[#6786DC] hover:bg-blue-50/50 rounded-xl font-semibold text-sm transition-all group">
                    ...
                    <a href="#" class="flex items-center gap-3.5 px-4 py-3 bg-[#E8EFFF] text-[#2D3E75] rounded-xl font-bold text-sm transition-all">
            ...
            <div class="p-4 border-t border-gray-50">
                <a href="#" class="flex items-center gap-3.5 px-4 py-3 text-red-500 hover:bg-red-50 rounded-xl font-bold text-sm transition-all">
        ...
        <div class="flex-1 flex flex-col ml-64">
            ...
            <header class="h-20 bg-white border-b border-gray-100 flex items-center justify-end px-8 gap-6 sticky top-0 z-50">
                <button class="w-10 h-10 rounded-xl bg-gray-50 hover:bg-gray-100 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-all">
                ...
                <div class="flex items-center gap-3.5">
                    ...
                    <div class="w-11 h-11 bg-gray-100 rounded-full border border-gray-200 flex items-center justify-center text-gray-600 shadow-sm overflow-hidden">
            ...
            <main class="p-8 flex-1">
                ...
                <div class="max-w-2xl mx-auto space-y-6">
                    ...
                    <div class="bg-white rounded-[32px] shadow-sm border border-gray-100/80 overflow-hidden">
                        <div class="p-8">
                            ...
                            <form action="#" method="POST" class="space-y-5">
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 mb-2 ml-1 uppercase tracking-wider">Kata Sandi Saat Ini</label>
                                    <div class="relative">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 mb-2 ml-1 uppercase tracking-wider">Kata Sandi Baru</label>
                                        <input type="password" name="new_password" placeholder="Masukan kata sandi baru" 
                                            class="w-full px-5 py-3.5 bg-[#F8FAFF] border border-gray-100 rounded-2xl outline-none focus:ring-2 focus:ring-blue-200 focus:bg-white transition-all text-sm">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-500 mb-2 ml-1 uppercase tracking-wider">Konfirmasi</label>
                                        <input type="password" name="new_password_confirmation" placeholder="Ulangi Sandi" 
                                            class="w-full px-5 py-3.5 bg-[#F8FAFF] border border-gray-100 rounded-2xl outline-none focus:ring-2 focus:ring-blue-200 focus:bg-white transition-all text-sm">
                                    </div>
                                </div>

                                <div class="pt-4">
                                    <button type="submit" class="w-full py-4 bg-[#1E3A8A] hover:bg-[#1A3175] text-white font-bold rounded-2xl shadow-lg shadow-blue-900/10 hover:shadow-xl transition-all flex items-center justify-center gap-2 text-sm">
                    ...
                    <div class="bg-[#0F296B] rounded-[24px] p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-md">
                        ...
                        <a href="https://wa.me/62812345678" target="_blank" class="px-6 py-2.5 bg-white text-[#0F296B] font-bold text-xs rounded-xl hover:bg-gray-50 transition-all whitespace-nowrap shadow-sm">
                            Hubungi Tim
                        </a>
                    </div>

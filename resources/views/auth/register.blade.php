...
<body class="bg-custom-gradient min-h-screen flex items-center justify-center p-4 md:p-8">
    ...
    <div
        class="bg-white/40 backdrop-blur-xl rounded-[40px] shadow-2xl w-full max-w-[1050px] flex overflow-hidden border border-white/60 p-5 min-h-[600px] lg:h-[620px]">
        ...
        <div class="w-full lg:w-1/2 p-6 md:p-8 flex flex-col justify-between h-full overflow-y-auto no-scrollbar">
            ...
            <div class="my-auto py-4">
                <div class="text-center mb-5">
                    ...
                    <p class="text-gray-500 text-xs font-semibold">Silahkan lengkapi data diri Anda untuk mendaftar ke
                        E-Jurnal.</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-3.5 max-w-[430px] mx-auto">
                    @csrf
